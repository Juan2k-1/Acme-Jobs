...
<p>
	<spring:message code="customer.action.2" />
</p>
<form:form modelAttribute="shout">
	<form:hidden path="id" />
	<form:hidden path="version" />
	<form:label path="username">
		<spring:message code="customer.username" />:</form:label>
	<form:input path="username" readonly="true" />
	<form:errors path="username" cssClass="error" />
	<br />
	<form:label path="link">
		<spring:message code="customer.link" />: </form:label>
	<form:input path="link" />
	<form:errors path="link" cssClass="error" />
	<br />
	<form:label path="text">
		<spring:message code="customer.text" />: </form:label>
